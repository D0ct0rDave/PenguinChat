...
TUser        *GetUserInfo     (unsigned int IPAddress);
char		 *GetHostName     (unsigned int IPAddress);
char	     *GetUserNick     (unsigned int IPAddress);
char         *GetUserActor    (unsigned int IPAddress);
